...
def predict():
    ...
    if str(movie) in moviemat.columns:#checking movie existance in our database
        ...
        return render_template('movie1.html', prediction="We are extremly sorry but this movie is not found in Our Movies Database. Please Check with database movies, thanks.")
